...
function CloseShiftDialog(props) {
    ...
    function checkIfClose() {
        return (countedLbp !== '' && countedUsd !== '' && paymentUsd !== '' && paymentLbp !== '' && otherPayment !== '');
    }
    useEffect(() => {
                            ...
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        ...
                                        placeholder='0'
                                        onChange={(e) => { let lbp = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setLbp100000(lbp); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let lbp = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setLbp50000(lbp); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let lbp = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setLbp20000(lbp); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let lbp = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setLbp10000(lbp); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let lbp = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setLbp5000(lbp); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let lbp = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setLbp1000(lbp); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let lbp = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setLbp500(lbp); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let lbp = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setLbp250(lbp); }}
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let usd = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setUsd100(usd); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let usd = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setUsd50(usd); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let usd = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setUsd20(usd); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let usd = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setUsd10(usd); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let usd = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setUsd5(usd); }}
                                    />
                                </div>
                            </div>
                            <div className='mb-10'>
                                ...
                                <div className={clsx(classes.input)}>
                                    <OutlinedInput
                                        inputProps={{ style: { padding: 11 } }}
                                        placeholder='0'
                                        onChange={(e) => { let usd = isNaN(parseInt(e.target.value)) ? 0 : parseInt(e.target.value); setUsd1(usd); }}
                                    />
                                </div>
                            </div>
                        </div>
