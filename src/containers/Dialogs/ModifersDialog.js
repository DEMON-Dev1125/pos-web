        ...
        <Dialog open={open} classes={{ paper: classes.dialogPaper }} TransitionComponent={Transition}
            ...
            <div className='overflowHidden'>
                <Swipeable
                    ...
                    onSwipedRight={() => setSwipeRight(false)}
                    trackMouse={true}
                    preventDefaultTouchmoveEvent={true}
                    className={clsx(swipeRight ? classes.swipeLeft : classes.swipeRight, classes.swipeArea, 'transitionArea')}
                >
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={1}>
                                <div className={classes.circleDiv}>
                                    {
                                        swipeRight ? <SvgCircleDisable /> : <SvgCircleActive />
                                    }
                                </div>
                            ...
                            <Grid item xs={1}>
                                <div className={classes.circleDiv}>
                                    {
                                        swipeRight ? <SvgCircleActive /> : <SvgCircleDisable />
                                    }
                                </div>
                            </Grid>
                        </Grid>
